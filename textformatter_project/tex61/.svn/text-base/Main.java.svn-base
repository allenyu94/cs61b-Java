...
public class Main {
    ...
    /**
     * Format the file ARGS[0], producing output on the standard output if
     * ARGS.length is 1, and otherwise on ARGS[1]. ARGS must have length 1 or 2.
     * Print a usage message otherwise or if the files are unreadable or
     * unwritable, respectively.
     */
