...
public class BoardTest {
    ...
    public void testNeighbors() {
        ...
        assertEquals("wrong number of neighbors", B.neighbors(0), 2);
        assertEquals("wrong number of neighbors", B.neighbors(1), 3);
        assertEquals("wrong number of neighbors", B.neighbors(2), 2);
        assertEquals("wrong number of neighbors", B.neighbors(3), 3);
        assertEquals("wrong number of neighbors", B.neighbors(4), 4);
        assertEquals("wrong number of neighbors", B.neighbors(5), 3);
        assertEquals("wrong number of neighbors", B.neighbors(6), 2);
        assertEquals("wrong number of neighbors", B.neighbors(7), 3);
        assertEquals("wrong number of neighbors", B.neighbors(8), 2);
    }
    ...
    public void testNumOfColor() {
        ...
        B.addSpot(RED, 1, 1);
        assertEquals("wrong number of color", B.numOfColor(RED), 1);
        B.addSpot(BLUE, 1, 2);
        assertEquals("wrong number of color", B.numOfColor(BLUE), 1);
    }
    ...
    public void testMove2() {
        ...
        checkBoard("#1", B, 1, 1, 1, RED);
        B.addSpot(BLUE, 1, 2);
        checkBoard("#2", B, 1, 1, 1, RED, 1, 2, 1, BLUE);
        B.addSpot(RED, 1, 1);
        checkBoard("#3", B, 1, 1, 2, RED, 1, 2, 1, BLUE);
        B.addSpot(BLUE, 1, 2);
        checkBoard("#4", B, 1, 1, 2, RED, 1, 2, 2, BLUE);
        B.addSpot(RED, 1, 1);
        checkBoard("#5", B, 1, 1, 2, RED, 1, 2, 1,
                RED, 2, 1, 1, RED, 2, 2, 1, RED);
    }
